...
import torch
from model.Wav2Lip import face_detection
from model.Wav2Lip.models.wav2lip import Wav2Lip
import platform
...
def main():
    ...
    """
        如何计算 80：
        假设音频的采样率是 16000 Hz（每秒 16000 个样本）。
        通常在梅尔频谱图的计算中，帧移（hop size）会设为 200，即每个时间步长对应的音频样本数是 200。
        因此，每秒钟音频可以产生 16000 / 200 = 80 个时间步长的音频特征。
    """
