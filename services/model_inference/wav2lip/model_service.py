...
# 任务队列
face_task_queue = VideoAndAudioToVideoTaskTaskQueue(100)
...
class VideoAndAudioToVideoService:
    ...
    def process_task(self, task: Dict):
        ...
        # 上传到 OSS
        result_object_key = task_id
        self.OSSVideoService.upload_video_from_bytes(result_object_key, result)
        # 删除临时文件
    ...
    def run(self):
        while True:
            ...
            try:
                ...
                face_task_queue.mark_task_as_done(task.get('task_id'), VideoAndAudioToVideoResultModel.parse_obj({
